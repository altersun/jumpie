...
class JumpTable {
    public:
        ...
        JumpTable(std::initializer_list<T> init_list) : container(init_list) {}

        // Explicit index constructor
        // Supports sparse filling when key is an integral type
        ...
        // Useful for iterating and bounds-checking
        auto Size() {
            return container.size();
        }

        // Mostly here for testing, but maybe it'll be useful otherwise?
